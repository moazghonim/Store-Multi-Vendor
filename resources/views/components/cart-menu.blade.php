        ...
        <ul class="shopping-list">
            ...
            <li>
                <form action="{{route('cart.destroy',$item->id)}}" method="POST">
                    {{method_field('DELETE')}}
                    {{@csrf_field()}}
                    <a href="javascript:void(0);" onclick="this.parentNode.submit();" class="remove" title="Remove this item"><i class="lni lni-close"></i>
                    </a>
                </form>
                <div class="cart-img-head">
                    <a class="cart-img" href="{{route('show.product',$item->product->slug)}}"><img src="{{$item->product->image_url}}" alt="#"></a>
                </div>
                <div class="content">
