                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-12 col-12">
                            <div class="product-info">
                                ...
                                <p class="category"><i class="lni lni-tag"></i> Drones:<a href="javascript:void(0)"></a>
                                </p>
                                <h3 class="price">
                                    {{ Currency::format($product->price)}}@if($product->compare_price)<span>{{ Currency::format($product->compare_price)}}</span>@endif
                                </h3>
