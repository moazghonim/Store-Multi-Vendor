        ...
        <div class="container">
            <div class="cart-list-head">
                ...
                <div class="cart-single-list" id="{{$item->id}}">
                    <div class="row align-items-center">
                        <div class="col-lg-1 col-md-1 col-12">
                            <a href="{{route('show.product',$item->product->slug)}}"><img src="{{$item->product->image_url}}" alt="#"></a>
                        </div>
                        <div class="col-lg-4 col-md-3 col-12">
                            <h5 class="product-name"><a href="{{route('show.product',$item->product->slug)}}">
                        ...
                        <div class="col-lg-2 col-md-2 col-12">
                            <div class="count-input">
                                <input class="form-control item-quantity" data-id="{{$item->id}}" value="{{$item->quantity}}" type="number">
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-2 col-12">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="right">
                                    ...
                                    <div class="button">
                                        ...
                                        <a href="{{route('products.all')}}" class="btn btn-alt">Continue shopping</a>
                                    </div>
                                </div>
                            </div>
                        </div>
